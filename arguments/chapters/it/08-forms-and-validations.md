...
1. [Paradigmi di Gestione dei Moduli](#1-form-management-paradigms)
2. [Componenti Controlled vs Uncontrolled](#2-controlled-vs-uncontrolled-components)
3. [React Hook Form: Gestione Moderna dei Moduli](#3-react-hook-form-modern-form-management)
4. [Validazione con Yup](#4-validation-with-yup)
5. [Validazione con Zod](#5-validation-with-zod)
6. [Gestione del Caricamento di File](#6-file-upload-handling)
7. [Moduli Multi-Step](#7-multi-step-forms)
8. [Gestione dello State del Modulo](#8-form-state-management)
9. [Pattern Avanzati per i Moduli](#9-advanced-form-patterns)
10. [Matrice di Selezione della Strategia per i Moduli](#10-form-strategy-selection-matrix)

---

## 1. Paradigmi di Gestione dei Moduli

### Classificazione dello State del Modulo
...
### Evoluzione degli Approcci ai Moduli
...
## 2. Componenti Controlled vs Uncontrolled

### Componenti Controlled

I **componenti controlled** hanno il proprio state del modulo gestito da React tramite `useState`, rendendo React la "singola fonte di verità" per i dati del modulo.
...
### Componenti Uncontrolled

I **componenti uncontrolled** memorizzano i dati del modulo nel DOM stesso, a cui si accede tramite i refs quando necessario.
...
### Flusso dei Dati: Controlled vs Uncontrolled

I due pattern differiscono per **dove risiede la fonte di verità**. I componenti controlled mantengono lo state in React; i componenti uncontrolled lo mantengono nel DOM e lo estraggono tramite i refs solo quando necessario.
...
### Confronto Controlled vs Uncontrolled
...
## 3. React Hook Form: Gestione Moderna dei Moduli
...
### Modulo Complesso con Tutti i Tipi di Campo
...
I validatori basati su schema come Zod e Yup seguono un semplice modello mentale di tipo parse-or-fail: i valori del modulo entrano e, in uscita, si ottiene o un oggetto tipizzato e validato, oppure un elenco strutturato di errori di campo.
...
## 6. Gestione del Caricamento di File
...
### Caricamento di File con Anteprima
...
### Caricamento di File con Drag and Drop
...
### Macchina a Stati dei Moduli Multi-Step

Un wizard è essenzialmente una macchina a stati finiti: ogni step è uno stato, e `Next`/`Back` sono transizioni protette dalla validazione. Modellarlo esplicitamente evita rami `if (step === 2)` intricati.
...
### Multi-Step con Persistenza dello State
...
### Multi-Step con Componente Wizard
...
## 8. Gestione dello State del Modulo
...
### State del Modulo Basato su Context
...
## 9. Pattern Avanzati per i Moduli
...
## 10. Matrice di Selezione della Strategia per i Moduli
...
## Conclusione: Padroneggiare la Gestione dei Moduli

**Gestione dei moduli magistrale! 📝** Scegli la tua strategia per i moduli in base alla complessità, ai requisiti di performance e alle esigenze di validazione. React moderno offre una flessibilità senza pari—sfruttala con saggezza!
